...
#ifndef INCLUDE_vnx_query_Or_HXX_
#define INCLUDE_vnx_query_Or_HXX_
...
class Or : public ::vnx::query::Expression {
public:
	...
	friend std::ostream& operator<<(std::ostream& _out, const Or& _value);
	friend std::istream& operator>>(std::istream& _in, Or& _value);
...
#endif // INCLUDE_vnx_query_Or_HXX_
