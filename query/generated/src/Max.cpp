...
const char* Max::get_type_name() const {
...
const vnx::TypeCode* Max::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x1728bd90ff0d8af8ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> Max::create_type_code() {
...
void write(TypeOutput& out, const ::vnx::query::Max& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vnx::query::Max>(out);
