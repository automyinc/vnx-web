...
const vnx::Hash64 DefaultView::VNX_CODE_HASH(0xc091387a109f4aa1ull);
...
void DefaultView::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, allow_directory_index);
...
std::shared_ptr<vnx::TypeCode> DefaultView::create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xc091387a109f4aa1ull);
