...
const char* Generic::get_type_name() const {
	return "vnx.web.Generic";
}
...
const vnx::TypeCode* Generic::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x637ae6178f4cc8e3ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> Generic::create_type_code() {
...
void write(TypeOutput& out, const ::vnx::web::Generic& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vnx::web::Generic>(out);
		vnx::write_class_header<::vnx::web::Generic>(out);
	}
