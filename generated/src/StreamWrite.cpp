...
const vnx::Hash64 StreamWrite::VNX_CODE_HASH(0xc040186971d76d6ull);
...
void StreamWrite::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, chunks);
...
std::shared_ptr<vnx::TypeCode> StreamWrite::create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xc040186971d76d6ull);
...
void read(TypeInput& in, ::vnx::web::StreamWrite& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const vnx::TypeField* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 1: vnx::read(in, value.chunks, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::web::StreamWrite& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.chunks, type_code, type_code->fields[1].code.data());
}
