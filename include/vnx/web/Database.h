...
#ifndef INCLUDE_VNX_WEB_DATABASE_H
#define INCLUDE_VNX_WEB_DATABASE_H
...
private:
	...
	void read_block(block_t &block, size_t block_index);
...
private:
	...
	bool is_replay = true;
	std::shared_ptr<const vnx::Request> current;
...
#endif // INCLUDE_VNX_WEB_DATABASE_H
